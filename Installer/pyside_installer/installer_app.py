"""Custom PySide6-based installer UI for Python App Builder.
...
(out/PythonAppBuilder when run from source, or the bundled 'payload' folder
...
APP_DISPLAY_NAME = "Python App Builder"
APP_EXE_NAME = "PythonAppBuilder.exe"
...
def PayloadDir():
    ...
    return os.path.join(BaseDir(), "out", "PythonAppBuilder")
