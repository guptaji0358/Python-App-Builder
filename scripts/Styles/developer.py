...
# its own selectable theme for anyone who prefers the classic style.
# Every stylesheet below is authored independently of Dark/Light - tuning
# those themes must never change a single pixel here.
    ...
    Result = {
        ...
        "ComboBoxStyle": """
                                ...
                                QComboBox QAbstractItemView
                                                            {
                                                                background-color: rgba(15,20,30,240);
                                                                color: white;
                                                                border: 1px solid rgba(255,255,255,40);
                                                                outline: none;
        ...
        "DialogStyle": """
                                ...
                                QTabBar::tab:selected
                                                        {
                                                            background: rgba(0,170,255,80);
                                                            border: 1px solid rgba(0,170,255,180);
                                                        }
                        """,
